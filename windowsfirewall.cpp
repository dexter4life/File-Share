...
void WindowsFirewall::WindowsFirewallCleanup(IN INetFwProfile* fwProfile)
{
...
HRESULT WindowsFirewall::WindowsFirewallInitialize(OUT INetFwProfile** fwProfile)
{
    HRESULT hr = S_OK;
...
HRESULT  WindowsFirewall::WindowsFirewallIsOn(IN INetFwProfile* fwProfile, OUT BOOL* fwOn)
{
    HRESULT hr = S_OK;
...
HRESULT  WindowsFirewall::WindowsFirewallTurnOn(IN INetFwProfile* fwProfile)
{
    HRESULT hr = S_OK;
    BOOL fwOn;
...
HRESULT  WindowsFirewall::WindowsFirewallTurnOff(IN INetFwProfile* fwProfile)
{
    HRESULT hr = S_OK;
    BOOL fwOn;
...
HRESULT  WindowsFirewall::WindowsFirewallAppIsEnabled(
...
HRESULT  WindowsFirewall::WindowsFirewallAddApp(
            IN INetFwProfile* fwProfile,
            IN const wchar_t* fwProcessImageFileName,
...
HRESULT  WindowsFirewall::WindowsFirewallPortIsEnabled(
            IN INetFwProfile* fwProfile,
            IN LONG portNumber,
...
HRESULT  WindowsFirewall::WindowsFirewallPortAdd(
            IN INetFwProfile* fwProfile,
            IN LONG portNumber,
            IN NET_FW_IP_PROTOCOL ipProtocol,
